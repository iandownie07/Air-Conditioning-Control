...
int main(int argc, const char * argv[]) {
    ...
    { // receive a transmission
        ...
        { // receive bytes until byte = e when a packet ends
            ...
            if (byteReceived > 0)
            {
                // WE COULD MAKE THIS INTO A METHOD "MAKE PACKET"
    ...
    int dy1 = 0; int mn1 = 0; int yr1 = 0;
    
    int dy2 = 0; int mn2 = 0; int yr2 = 0;
   ...
   /* while(true)
    ...
    cout << "3. See the total heater usage during a date range" << endl;
    list1.listar();
        cin  >> option;
        switch(option)
        {
